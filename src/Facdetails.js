...
const Facdetails=()=>{
    ...
    useEffect(()=>{
        fetch("https://66ed09d2380821644cdb11d3.mockapi.io/faculty"+params.id)
            .then((res)=>{
                return res.json();
            })
            .then((res)=>{
        ...
        <>
            <div className="">
                    <img src={fac1.pho} alt="image cap" />
                        ...
                        <button className="btn btn-primary" onClick={()=>{ fetch("https://66ed09d2380821644cdb11d3.mockapi.io/faculty"+params.id,{method:"DELETE"})
            .then((res)=>{
                return res.json();
            })
            .then(()=>{
